<!-- DISCLAIMER PAGE ----------------------------------------->
<section class="section nomodal" id="imprint">   
                        ...
                        <div class="row">
                          <h1>Datenschutzerklärung</h1>
                                <div class="col-md-12">
                                    ...
                                    sowie das automatische Löschen der Cookies beim Schließen des Browser aktivieren. <br/><br/>
                                    </p>
                                   ...
                                   bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.<br/><br/>
                                    </p>
                           ...
                           <h1>Haftungsausschluss</h1>
                                <div class="col-md-12">
                                    ...
                                    erstellt wurden, werden die Urheberrechte Dritter beachtet. Insbesondere werden Inhalte Dritter als solche gekennzeichnet (siehe 
                                    <a href="./index.php?page=imprint" data-index="2">Credits</a>). 
