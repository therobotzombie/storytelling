...
<!-- WARNING MESSAGE -->   
	<div id="warning">
   	    <p>This website is powered by new shiny CSS3 and SVG filters! To see everything in full glory, grab yourself <a href="http://www.google.com/chrome/" rel="nofollow" title="Go to google.com/chrome">Google Chrome 
		...
		<?php if(($page!='home')&&($page!='')) : ?>
    		 ...
    		 <?php else : ?>
         		<span data-toggle="tooltip" data-placement="right" title="What is this all about?">
                    <a href="#about" class="logo_home click" title="What is this all about?" data-toggle="modal" data-target="#aboutModal">
...
<!-- NAVIGATION -->   
	<div id="sound_options">
   	    <a id="onoff" class="click" value="on" data-index="2" title="Sound On/Off"><img src="./img/audio-on.svg" /></a>
    </div>
 ...
 <!-- EXTRA NAVIGATION FOR SCENES -->  
    ...
    if(isset($_GET['page'])){ 
        switch($_GET['page']){
			...
			case "eyre": $previous_scene="./index.php?page=cemetery"; $next_scene="./index.php?page=canyon"; break;
        } 
    }
    ?>
     <div id="extra_nav"> 
